...
#define SMARTRF_SETTING_IOCFG0     	0x80    //Collega sull'uscita GDO0 il sensore di temperatura.
#define SMARTRF_SETTING_FIFOTHR    	15      //Massimo 3 pacchetti.
...
#define SMARTRF_SETTING_PTEST           0xBF   //Valore da adottare per abilitare il sensore di temperatura.
